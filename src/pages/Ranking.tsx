            ...
            {(drivers || []).map((driver: any, i) => (
              ...
              >
                <span className={`font-heading text-xl font-bold w-10 text-center ${
                  i === 0 ? "text-gold" : i === 1 ? "text-muted-foreground" : i === 2 ? "text-fire-orange" : "text-muted-foreground"
                }`}>
                  #{i + 1}
                </span>
                ...
                <div className="hidden sm:flex items-center gap-4 text-sm text-muted-foreground">
                  <div className="flex items-center gap-1">
                    ...
                    <span className="font-display">{driver.viagens}</span>
                  </div>
                  <div className="flex items-center gap-1">
                    <MapPin className="h-4 w-4" />
                    <span className="font-display">{driver.km_rodados.toLocaleString("pt-BR")} km</span>
                  </div>
                </div>
